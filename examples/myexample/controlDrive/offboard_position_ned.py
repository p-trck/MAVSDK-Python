...
async def run():
    ...
    print("-- goto S..")
    await drone.offboard.set_position_ned(PositionNedYaw(-0.3, 0.0, -1.0, 0.0))
    await async_input("Press any key")
    ...
    print("-- goto E..")
    await drone.offboard.set_position_ned(PositionNedYaw(0.0, 0.3, -1.0, 0.0))
    await async_input("Press any key")
...
#
#    print("-- Go 0m North, 1m East, 0m Down \
#            within local coordinate system")
#    await drone.offboard.set_position_ned(
#            PositionNedYaw(0.0, -1.0, -1.0, 0.0))
